...
import datn.duong.FishSeller.security.JwtRequestFilter;
import datn.duong.FishSeller.service.AppUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> auth
                    ...
                    .requestMatchers("/status", "/test","/healthCheck","/register","/activate","/login","/forgot-password","/reset-password").permitAll()
